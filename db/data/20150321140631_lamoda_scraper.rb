  ...
  def up
    ...
    Scraper.find_or_create_by! name: 'Lamoda' do |scraper|
      ...
      Partition.create! name: 'Lamoda Body', scope: 'body', source: scraper, order: 1 do |lamoda_partition|
        Extractor.create! [{partition: lamoda_partition, type: 'ConstantValue', name: 'Partner', key: 'partner_id', value: lamoda.id,
                            element: '', attr: '', pattern: '', replacement: '', required: true},
                           {partition: lamoda_partition, type: 'Text', name: 'Value Name', key: 'name', value: '',
                            element: 'a.product-card__header-link', attr: '', pattern: '', replacement: '', required: false},
                           {partition: lamoda_partition, type: 'Text', name: 'Value New Price', key: 'new_price', value: '',
                            element: '.product-card__price span.price__new', attr: '', pattern: '\D', replacement: '', required: true},
                           {partition: lamoda_partition, type: 'Text', name: 'Value Discount', key: 'discount', value: '',
                            element: 'span.product-label', attr: '', pattern: '\D', replacement: '', required: false},
                           {partition: lamoda_partition, type: 'Text', name: 'Value Old Price', key: 'old_price', value: '',
                            element: '.product-card__price span.price__old',
                            attr: '', pattern: '\D', replacement: '', required: true},
                           {partition: lamoda_partition, type: 'Attachment', name: 'Value Thumb', key: 'thumb', value: '',
